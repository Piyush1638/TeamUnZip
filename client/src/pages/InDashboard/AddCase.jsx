...
const AddCases = () => {
  const { addCase } = useContext(EvaultContext);
  const [formData, setFormData] = useState({
    clientId: "",
    caseId: "",
    lawyerId: "", // Fix typo here
    documentLink: "",
  });

  const { clientId, caseId, lawyerId, documentLink } = formData;
  ...
  const onSubmit = async (e) => {
    e.preventDefault();
    if (!clientId || !caseId || !lawyerId || !documentLink)
      return alert("All fields must be filled.");
    addCase(caseId, clientId, lawyerId, documentLink);
  };
